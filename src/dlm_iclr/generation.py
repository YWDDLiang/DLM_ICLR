...
import torch
from crystal_dlm import paired_llada, r03_geometry_bridge
...
from crystal_dlm.fixed_slot import FixedSlotConfig, MASK_TOKEN_ID, Z_TO_SYMBOL
...
class Constructor:
    def __init__(self, model, tokenizer, policy):
    ...
    def generate(self, plan):
        ...
        graph = None
        try:
            sampler = partial(construct, temperature=self.policy.temperature)
            ...
            from .refinement import graph_from_arrays
