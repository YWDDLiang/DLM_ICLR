...
def _featurize(payload):
    ...
    from dlm_iclr._vendor.crysllmgen.direct_constants import CompScalerMeans, CompScalerStds
...
def compute_features(structures, *, cache, workers=1):
    ...
    identity = {
        ...
        "scaler": file_hash(Path(__file__).parents[1] / "_vendor/crysllmgen/direct_constants.py"),
