...
from dlm_iclr._vendor.crysllmgen.models_ddpm.diff_utils import BetaScheduler, SigmaScheduler


from dlm_iclr._vendor.crysllmgen.models_ddpm.diff_utils import d_log_p_wrapped_normal


from dlm_iclr._vendor.crysllmgen.models_ddpm.data_utils import lattice_params_to_matrix_torch
...
class CSPDiffusion(nn.Module):
    ...
    def forward(self, batch):
        ...
        tar_x = d_log_p_wrapped_normal(sigmas_per_atom * rand_x, sigmas_per_atom) / torch.sqrt(
