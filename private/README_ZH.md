...
> **故事入口：** [物理反馈 Master Story](../docs/PHYSICAL_FEEDBACK_MASTER_STORY_ZH.md) 将原方法组织为周期构造与物理反馈学习，C2 的教师训练和验证机制见本目录。主实验配置与结果保持原绑定；[注册教师/前缀反馈](../docs/C1_C2_METHOD_ZH.md)作为独立研究配方保留。
